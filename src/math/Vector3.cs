...
namespace RayTracer
{
    ...
    public readonly struct Vector3
    {
        ...
        {
            //Vector3 newVec3 = new Vector3(this.x, this.y, this.z);
            // Write your code here...
            double lengthSQ = Math.Pow(this.x, 2) + Math.Pow(this.y, 2) + Math.Pow(this.z, 2);
            //double LengthSquare = Math.Sqrt(length);
        ...
        {
            // Write your code here...     
            Vector3 newVec3 = new Vector3((this.x / Length()), (this.y / Length()), (this.z / Length()));
